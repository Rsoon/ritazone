class CartController < ApplicationController
  ...
  def add_to_cart
    line_item = LineItem.create(product_id: params[:product_id], 
    ...
    #another way to use the line_item description 
...
#line_item = LineItem.new
 #    line_item.product_id = params[:product_id]
  ...
  def checkout
    ...
    @line_items.each do |line_item|    #this part starts the inventory cntrl
      line_item.product.quantity -= line_item.quantity # quantity is the attribute of that product
